    ...
    foreach ($file in $definitionFiles) {
        ...
        if ($null -ne $importPolicyDefinitionGroups) {
            ...
            foreach ($importPolicyDefinitionGroup in $importPolicyDefinitionGroups) {
                ...
                Write-Information "Imported PolicyDefinitionGroups from '$($deployedDefinitions.all)'."
                ...
                Write-Information "Imported PolicyDefinitionGroups from '$($importedPolicySetDefinition)'."
